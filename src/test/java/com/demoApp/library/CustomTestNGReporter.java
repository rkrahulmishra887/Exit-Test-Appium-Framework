...
public class CustomTestNGReporter implements IReporter {
    ...
    private static final String emailableReportTemplateFile = System.getProperty("user.dir") + File.separator + "/customize-emailable-report-template.html";
...
//			String customReportTitle = this.getCustomReportTitle("Summary Report");

            // Create test suite summary data.
            String customSuiteSummary = this.getTestSuiteSummary(suites);

            String outputReportDirectory = System.getProperty("user.dir") + "/reports/";
            ...
            File targetFile = new File(outputReportDirectory + "SummaryTestReport.html");
